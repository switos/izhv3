...
public class Enemy : MonoBehaviour
{
    ...
    /// </summary>
    private UnityEngine.BoxCollider mBoxTrigger;
    
    /// <summary>
    /// Collider of the Enemy.
    /// </summary>
    private UnityEngine.BoxCollider mBoxCollider;
    ...
    private void Awake()
    {
        ...
        var colliders = GetComponents<UnityEngine.BoxCollider>();
    ...
    void FixedUpdate()
    {
        ...
        GameObject player = GameManager.Instance.NearestPlayer(position);
        ...
        var moveDelta = directionToPlayer * speed * Time.deltaTime;
